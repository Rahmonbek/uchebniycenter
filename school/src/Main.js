...
import { BiGroup, BiDollarCircle } from "react-icons/bi";
...
export default class Main extends Component {
  ...
  render() {
    ...
    return GLOBAL.id !== null ? (
      <div>
        <BrowserRouter>
          <div className={styles.top} style={{ overflow: "hidden" }}>
            <h1
              className={this.state.collapsed ? styles.header1 : styles.header2}
            >
              IT Tower
            </h1>
            <div
              onClick={this.toggleCollapsed}
              className={this.state.collapsed ? styles.btntop1 : styles.btntop}
            >
              <div></div>
              <div></div>
              <div></div>
            ...
            <div
              className={this.state.collapsed ? styles.search1 : styles.search}
            >
              <input
                className={
                  this.state.open ? styles.inputSearch1 : styles.inputSearch
                }
                type="text"
              ...
              <div
                className={
                  this.state.open ? styles.iconSearch1 : styles.iconSearch
                }
              >
                <GoSearch
                  onClick={this.open}
                  style={{ fontSize: "19px", color: "#3F6AD8" }}
                />
              </div>
              <div
                onClick={this.close}
                className={
                  this.state.open ? styles.closeIcon1 : styles.closeIcon
                }
              >
                <VscChromeClose
                  style={{ fontSize: "22px", color: "#8AA4E6" }}
                />
              </div>
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "row" }}>
            ...
            >
              ...
              >
                ...
                <div
                  className={
                    this.state.collapsed ? styles.hrMenu1 : styles.hrMenu2
                  }
                ></div>
                <Menu.Item
                  key="1"
                  ...
                  className={this.state.collapsed ? styles.list1 : styles.list2}
                >
                  <Link
                ...
                >
                  <Menu.Item
                    className={
                      this.state.collapsed ? styles.list1 : styles.list2
                    }
                    key="4"
                  >
                    Front-end (React)
            ...
            <div
              className={this.state.collapsed ? styles.forget1 : styles.forget}
            >
              <Switch>
